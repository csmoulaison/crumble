...
draw_level_indicator :: proc(position: IVec2, session: ^Session, platform: ^Platform) {
	...
	level_head: IRect = {{277, 110}, {24, 8}}
	level_num_text: IRect = {{262 + session.current_level * 7, 222}, {7, 7}}
	level_title_text: IRect = {{213, 222 + session.current_level * 5}, {max_title_width, 5}}
